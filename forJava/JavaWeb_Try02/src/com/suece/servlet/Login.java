...
import com.suece.utils.JDBCUtils;
import com.suece.utils.ShaUtil;
 ...
 *    如果这次不保存密码(即复选框不打勾)，将之前的cookies遍历cookies将cookies清空， 后跳转计科院
 *
 *
 */
...
public class Login extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            String userPassword_sha256 = ShaUtil.getSHA256(userPassword,true);
